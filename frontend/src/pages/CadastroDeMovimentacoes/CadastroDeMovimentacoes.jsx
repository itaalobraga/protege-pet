...
function CadastroDeMovimentacoes() {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      ...
      exibirToast("Entrada registrada com sucesso!", "success");
      limparFormulario();
      carregarProdutos();
      ...
      exibirToast(error.message || "Erro ao registrar entrada.", "danger");
    } finally {
      setLoading(false);
    }
  };
      ...
      <Container className="py-4">
        <Card className="shadow-sm border-0">
          <Card.Body className="p-4">
            <h3 className="fw-bold mb-2">Entrada de Produtos</h3>
            <p className="text-muted mb-4">
              Registre aqui Entradas de Produtos no Estoque. Se for produto novo, clique no botão verde para cadastrar ele.
            </p>
